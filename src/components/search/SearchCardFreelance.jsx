                        ...
                        <div className="text-right mt-4 md:mt-0">
                            ...
                            <button
                              ...
                              //  className="btn-primary bg-primary text-white hover:bg-blue-600 rounded-full font-medium px-3 py-1 transition-colors duration-300"
                                className="btn-primary bg-primary-500   text-white  sm:px-3  sm:py-1 rounded-md hover:bg-blue-600 font-medium px-3 py-1 flex items-center justify-center text w-full sm:w-auto transition-colors duration-300"
                            >
                                See more
                            </button>
